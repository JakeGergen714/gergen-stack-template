...
- `ARTIFACT_BUCKET`: The name of the S3 bucket created by the stack for artifacts (see Terraform output `artifact_bucket_name` - _Wait, I added this to outputs.tf_).
